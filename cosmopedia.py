...
def process_shard(vocab_size=None):
    #tokenizer_model = get_tokenizer_model_path(vocab_size)
    enc = Tokenizer("./tokenizer.model")
    dataset = load_dataset("HuggingFaceTB/cosmopedia-100k",split="train", num_proc=20)
...
class PretokDataset(torch.utils.data.IterableDataset):
    ...
    def __iter__(self):
        ...
        shard_filenames = ["./val.bin","./train.bin"]
